...
public class BabyWolfModel<T extends Wolf> extends WolfModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = root.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(0.0F, 18.25F, -4.0F));
        PartDefinition realHead = head.addOrReplaceChild("real_head", CubeListBuilder.create().texOffs(0, 12).addBox(-3.0F, -3.25F, -3.0F, 6.0F, 5.0F, 5.0F).texOffs(17, 12).addBox(-1.5F, -0.25F, -5.0F, 3.0F, 2.0F, 2.0F), PartPose.ZERO);
        realHead.addOrReplaceChild("right_ear", CubeListBuilder.create().texOffs(0, 5).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F), PartPose.offset(-2.0F, -4.25F, -0.5F));
        realHead.addOrReplaceChild("left_ear", CubeListBuilder.create().texOffs(20, 5).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F), PartPose.offset(2.0F, -4.25F, -0.5F));
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.head.xRot = headPitch * Mth.DEG_TO_RAD; // 0.017453292F
...
//        this.realHead.zRot = entity.getHeadRollAngle(partialTick) + entity.getBodyRollAngle(partialTick, 0.0F); TODO: Find how to fix this, because it makes the puppy's head spin 3 times or so, so it's best disabled
