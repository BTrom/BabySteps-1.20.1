...
import com.botrom.babysteps.client.animations.BabyArmadilloAnimation;
import net.minecraft.client.model.geom.ModelPart;
import net.minecraft.client.model.geom.PartPose;
import net.minecraft.client.model.geom.builders.*;
import net.minecraft.world.entity.Entity;

// I'm commenting this class out until I plug in VB or add them myself like I did in the main mod

//public class BabyArmadilloModel<T extends Entity> extends ArmadilloModel {
public class BabyArmadilloModel<T extends Entity> {
